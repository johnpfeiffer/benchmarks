...
// Historical snapshots: the 2026-08-11 backfill of Intelligence Index v4.1.1
// rows, the 2026-02-19 backfill of v4.0.2 rows, and the 2025-12-30 backfill
// of v3.0 rows, each kept in its own file so ai.json stays the curated
// current ledger.
...
function DashboardPage() {
  ...
  // The v4.1.1, v4.0.2, and v3.0 backfills augment ai.json: one row per model
  // per version, so the version toggle can show the 2026-08-11, 2026-02-19,
  // and 2025-12-30 snapshots alongside the current ones.
